...
export const TeleprompterView: React.FC<TeleprompterViewProps> = ({ segments, onClose }) => {
    ...
    // Fix: explicitly provide null to useState to satisfy React type definitions
            ...
            try {
                ...
                if (videoRef.current) {
                    ...
                    if (track.getCapabilities) {
                        ...
                        // Fix: use null or cast properly for capabilities fallback
                        setCameraCapabilities(null); 
                    }
                }
            } catch (error) {
    ...
    // Fix: cast cameraCapabilities to any for non-standard properties like torch and zoom
                ...
                >
                    ...
                    {isCameraActive && (
                        <div className="space-y-3 pt-2 border-t border-zinc-800">
                            ...
                            {/* Fix: cast cameraCapabilities and cameraSettings to any for non-standard properties */}
                            ...
                            {/* Fix: cast cameraCapabilities and cameraSettings to any for zoom property */}
